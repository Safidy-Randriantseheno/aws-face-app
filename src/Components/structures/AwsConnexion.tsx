    ...
    return (
        <div className="main">
            <label htmlFor="input-img">
                <div className="inputField" >Add image</div>
            </label>
                ...
                <div className="right-container">
                    {
                       (DataList || []).map(function (key: string) {
                            return (
                                 <>
                                     { key[0]  === "" ? <Loader/> : <p className='title'>{key[0]}</p>}
                                     {
                                                 ...
                                                 <div >
                                                     {
                                                        ...
                                                        Object.entries(element[1]).map(e =>
                                                            ...
                                                            : <div className="info"><div className="left-info" >{element[0]}</div> :
                                                                <div className="right-info" >{element[1]}</div></div>
